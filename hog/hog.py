...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            ...
            score0 = score0 + take_turn(numofrolls0, score1, dice)
            if is_swap(score0, score1):
                score0, score1 = score1, score0
        else:
            numofrolls1 = strategy1(score1, score0)
            score1 = score1 + take_turn(numofrolls1, score0, dice)
            if is_swap(score0, score1):
                score0, score1 = score1, score0
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    target_score = score + free_bacon(opponent_score)
    if is_swap(target_score, opponent_score) and target_score < opponent_score:
        return 0
    if free_bacon(opponent_score) >= margin and not is_swap(target_score, opponent_score):
        return 0
    return num_rolls
    # END PROBLEM 11
